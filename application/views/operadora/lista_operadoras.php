        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li><?php echo anchor('operadora/salir','Salir'); ?></li>
            </ul>
          </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
      </nav>
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            <!---->
            <a href="<?php echo base_url();?>index.php/operadora/nueva" class="btn btn-success btn-sm pull-right">
              <span class="glyphicon glyphicon-plus"></span>&nbsp;Agregar Operadora
            </a>
            <br><br>
        				...
        				<tbody>
        					<?php
        		              if ($lista !== FALSE) {
                                ...
                                <td>
                                 <?php echo  $fila->nombre_operadora ?>
                               </td>
                                <td>
                               ...
                               <td>
                                 <?php echo anchor('operadora/detalle/'.$fila->id,'Detalle', array('class'=>'btn btn-info btn-xs')) ?>
                               </td>
        		                  </tr>
