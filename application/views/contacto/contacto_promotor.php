...
<div class="container">
	<div class="row">
      ...
      <form action="<?php echo base_url();?>/index.php/contacto/enviar" method="post" role="form" class="form-validacion">
                ...
                <div class="form-group">
								<label for="nombre-agencia">Nombre de Agencia o Promotora</label>
								<input type="text" class="form-control" name="nombre-agencia" id="nombre-agencia" placeholder="Nombre de la agencia o promotora" />
                ...
                <div class="form-group">
                    ...
                    <option selected value="promotor">Promotor</option>
                  </select>
        				</div>
                <div class="form-group">
								<label for="servicios">Servicios</label>
                <input type="text" class="form-control" name="servicios" id="servicios" placeholder="Servicios que ofreces" />
                <p class="help-block">Ejemplos: Tours, Paquetes, promociones, etc.</p>
							  </div>
							  <div class="form-group">
