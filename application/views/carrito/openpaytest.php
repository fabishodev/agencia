...
<body>
  <h1>OpenPay <small>Sandbox</small></h1>
    <div class="bkng-tb-cntnt">
        <div class="pymnts">
            <form action="<?php echo base_url();?>index.php/openpaytest/cargar" method="POST" id="payment-form">
              <input type="text" id="amount" name="amount" value="1.0" readonly>
              <input type="text" id="description" name="description" value="Cargo de prueba" readonly>
